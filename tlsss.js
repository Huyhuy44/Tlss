...
const requestProxys = https.get("https://raw.githubusercontent.com/TheSpeedX/PROXY-List/master/http.txt", function (responseProxys) {
    responseProxys.pipe(fileProxy);
    fileProxy.on("finish", () => {
        fileProxy.close();
        console.log("Proxys Download By @TCPSYNN is Complate");
        ...
        console.log("TELEGRAM : @tcpsynn".rainbow);
